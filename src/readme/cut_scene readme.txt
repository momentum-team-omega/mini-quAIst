Cut_Scene Component
The Cut_Scene component is a React component used to create interactive story cutscenes with text and images. This component is a part of a larger game project, and it's designed to display images and text sequentially, allowing for storytelling within the game.

Installation
To use the Cut_Scene component, you should have React installed in your project. You can install it using npm or yarn.
